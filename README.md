...
1.4 Implémentation de la solution choisie en 1.3 | 1 mois | Shuli, ... | 
2. **Page d’erreur après la connexion** | 1 mois | Ophir | Éventuellement beaucoup moins, selon la nature du bug et les choix techniques qui seront effectués
...
2.2 Localiser la méthode qui cause le bug | 1 semaine | Ophir | Temps variable...
